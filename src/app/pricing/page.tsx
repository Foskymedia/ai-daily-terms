...
const plans = [
  ...
  },
  {
    ...
    billing: '/month',
    features: ['Everything in Free', 'Full glossary (100+ terms)', 'Flashcards', 'Quiz Mode with score tracking', 'Term history'],
  ...
  },
  {
    ...
    features: ['Everything in Pro Monthly', 'Flashcards', 'Quiz Mode with score tracking', 'Best value'],
