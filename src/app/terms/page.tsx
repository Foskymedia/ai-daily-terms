    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="space-y-8 text-gray-600 leading-relaxed">
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">1. Agreement</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">4. Payments and subscriptions</h2>
            <ul className="list-disc pl-6 space-y-2">
          ...
          <section>
            <h2 className="text-xl font-bold text-gray-900 mb-3">7. Availability</h2>
            <p>
