      ...
      <div className="bg-white rounded-2xl w-full max-w-md p-8 relative">
        ...
        {step === 2 && (
          <>
            ...
            {term ? (
              <>
                <h2 className="text-2xl font-bold text-gray-900 mb-3">{term.term}</h2>
              ...
              <div className="space-y-3 mb-8">
                ...
                <div className="h-4 bg-gray-100 animate-pulse rounded-lg w-5/6" />
                <div className="h-4 bg-gray-100 animate-pulse rounded-lg w-4/6" />
              </div>
            )}
            <button
              onClick={() => setStep(3)}
        ...
        {step === 3 && (
          <>
            ...
            {!saved ? (
              ...
              <div className="w-full bg-green-50 text-green-700 py-3 rounded-xl font-semibold text-center mb-3">
                Saved! ✓
              </div>
            )}
            <button
        ...
        {step === 4 && (
          <>
            <div className="text-4xl mb-4">🚀</div>
            <h2 className="text-2xl font-bold text-gray-900 mb-3">Go further with Pro</h2>
            <p className="text-gray-500 mb-6">
            ...
            <button
              onClick={markComplete}
              className="w-full text-gray-400 py-2 text-sm hover:text-gray-600 transition-colors mt-3"
            >
